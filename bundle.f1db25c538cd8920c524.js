...
/* harmony export */   reviveProject: () => (/* binding */ reviveProject)
/* harmony export */ });
/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo.js */ "./modules/todo.js");


const Project = ({ id = crypto.randomUUID(), name = "Untitled", todos = [] } = {}) => ({
  id, name, todos,
...
const reviveProject = (plain) => {
  ...
  (plain.todos || []).forEach(t => p.add((0,_todo_js__WEBPACK_IMPORTED_MODULE_0__.reviveTodo)(t)));
  return p;
};
...
/* harmony export */ });
/* harmony import */ var _project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project.js */ "./modules/project.js");
/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo.js */ "./modules/todo.js");
...
const Storage = (() => {
  ...
  const load = () => {
    ...
    if (!raw) {
      const p = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.Project)({ name: "My First Project" });
      return { projects: [p], currentId: p.id };
    }
    const parsed = JSON.parse(raw);
    return {
      projects: parsed.projects.map(_project_js__WEBPACK_IMPORTED_MODULE_0__.reviveProject),
...
/* harmony export */   reviveTodo: () => (/* binding */ reviveTodo)
/* harmony export */ });
...
const Todo = ({
  ...
  toDisplayDate() {
    ...
    try { return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(this.dueDate), "pp"); }
    catch { return this.dueDate; }
  }
});

const reviveTodo = (plain) => Todo(plain);
...
const UI = (() => {
  ...
  const persist = () => _storage_js__WEBPACK_IMPORTED_MODULE_2__.Storage.save(projects, currentProjectId);
  ...
  const newTodoPrompt = () => {
    ...
    return (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.Todo)({ title, description, dueDate, priority });
  };
  ...
  const bindEvents = () => {
    els.addProjectBtn.addEventListener("click", () => {
      ...
      if (!name) return;
      const p = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.Project)({ name });
      projects.push(p);
      currentProjectId = p.id;
      persist(); renderAll();
    });
  ...
  const init = () => {
    const { projects: loaded, currentId } = _storage_js__WEBPACK_IMPORTED_MODULE_2__.Storage.load();
...
body{ background:#c6c6c6;font-family:ui-serif, Georgia, "Times New Roman", serif;color:#fff }
...
.sidebar {
  border-right: 3px solid #ffffff99;
  padding: 18px;
  display: flex;
...
.project-item.active { outline:3px solid #fff}
...
.board { padding:22px 28px 28px }
.board-head { display:flex;align-items:center;gap:16px }
.board-head h2{ margin:0;font-size:26px }
.rule { height:3px;background:#ffffff99;flex:1;border-radius:2px }

.pill {
  margin: 12px 0 10px;
  border: 2px solid #fff;border-radius:12px;background:var(--pill);
  color: #fff;padding:8px 14px;cursor:pointer;font-weight:700;backdrop-filter:blur(2px)
}

#emptyHint { margin-top:8px;color:#f3f8fc }

.task-list { list-style:none;margin:10px 0 0;padding:0;display:flex;flex-direction:column;gap:10px }
.task {
  background: #fdfdfd;color:#111;border-radius:6px;box-shadow:var(--shadow);
  padding: 10px 12px;display:grid;grid-template-columns:auto 1fr auto auto;gap:8px;align-items:center
}
.task .title { font-weight:700 }
.task .due { font-size:12px;color:#4a4a4a }
.task .prio {
  width:10px;height:10px;border-radius:50%;
}
.prio-low { background:#76b041 }
.prio-med { background:#e6b800 }
.prio-high { background:#d74a4a }

.task .expander{ grid-column:1 / -1;margin-top:6px;color:#222;font-size:14px;display:none }
.task.expanded .expander{ display:block }
.controls{ display:flex;gap:8px }
.controls .icon-btn{ color:#222;border:1px solid #ddd;border-radius:4px;padding:4px 6px;background:#fff }`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,gBAAgB;EAChB,eAAe;EACf,aAAa;EACb,eAAe;EACf,gBAAgB;EAChB,mCAAmC;AACrC;;AAEA,GAAG,sBAAsB;AACzB,WAAW,WAAW,CAAC,SAAS;AAChC,MAAM,kBAAkB,CAAC,uDAAuD,CAAC,WAAW;;AAE5F;EACE,aAAa;EACb,aAAa;EACb,gCAAgC;EAChC,uBAAuB;EACvB,8CAA8C;AAChD;;AAEA;EACE,iCAAiC;EACjC,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,2BAA2B;EAC3B,kBAAkB;EAClB,kBAAkB;EAClB,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB,gBAAgB;AAClB;AACA;EACE,gBAAgB;EAChB,YAAY;EACZ,WAAW;EACX,eAAe;EACf;AACF;AACA;EACE,gBAAgB;EAChB,SAAS;EACT,UAAU;EACV,aAAa;EACb,sBAAsB;EACtB;AACF;AACA;EACE,gBAAgB;EAChB,WAAW;EACX,kBAAkB;EAClB,kBAAkB;EAClB,aAAa;EACb,8BAA8B;EAC9B,mBAAmB;EACnB;AACF;AACA,uBAAuB,sBAAsB;AAC7C,gBAAgB,eAAe;;AAE/B;EACE,gBAAgB;EAChB,YAAY;EACZ,WAAW;EACX,eAAe;EACf;AACF;;AAEA,SAAS,uBAAuB;AAChC,cAAc,YAAY,CAAC,kBAAkB,CAAC,SAAS;AACvD,gBAAgB,QAAQ,CAAC,eAAe;AACxC,QAAQ,UAAU,CAAC,oBAAoB,CAAC,MAAM,CAAC,kBAAkB;;AAEjE;EACE,mBAAmB;EACnB,sBAAsB,CAAC,kBAAkB,CAAC,sBAAsB;EAChE,WAAW,CAAC,gBAAgB,CAAC,cAAc,CAAC,eAAe,CAAC;AAC9D;;AAEA,aAAa,cAAc,CAAC,cAAc;;AAE1C,aAAa,eAAe,CAAC,eAAe,CAAC,SAAS,CAAC,YAAY,CAAC,qBAAqB,CAAC,SAAS;AACnG;EACE,mBAAmB,CAAC,UAAU,CAAC,iBAAiB,CAAC,wBAAwB;EACzE,kBAAkB,CAAC,YAAY,CAAC,wCAAwC,CAAC,OAAO,CAAC;AACnF;AACA,eAAe,gBAAgB;AAC/B,aAAa,cAAc,CAAC,cAAc;AAC1C;EACE,UAAU,CAAC,WAAW,CAAC,iBAAiB;AAC1C;AACA,YAAY,mBAAmB;AAC/B,YAAY,mBAAmB;AAC/B,aAAa,mBAAmB;;AAEhC,iBAAiB,kBAAkB,CAAC,cAAc,CAAC,UAAU,CAAC,cAAc,CAAC,aAAa;AAC1F,0BAA0B,cAAc;AACxC,WAAW,YAAY,CAAC,QAAQ;AAChC,qBAAqB,UAAU,CAAC,qBAAqB,CAAC,iBAAiB,CAAC,eAAe,CAAC,gBAAgB","sourcesContent":[":root {\r\n  --blue:#74a3c3;\r\n  --blue-d:#5e8fb1;\r\n  --panel:#ffffff;\r\n  --ink:#1b2b38;\r\n  --muted:#e9eef2;\r\n  --pill:#ffffff22;\r\n  --shadow:0 8px 20px rgba(0,0,0,.18);\r\n}\r\n\r\n*{ box-sizing:border-box }\r\nhtml,body{ height:100%;margin:0 }\r\nbody{ background:#c6c6c6;font-family:ui-serif, Georgia, \"Times New Roman\", serif;color:#fff }\r\n\r\n#app {\r\n  height: 100vh;\r\n  display: grid;\r\n  grid-template-columns: 300px 1fr;\r\n  background: var(--blue);\r\n  box-shadow: inset 0 0 0 9999px rgba(0,0,0,.03);\r\n}\r\n\r\n.sidebar {\r\n  border-right: 3px solid #ffffff99;\r\n  padding: 18px;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 14px;\r\n}\r\n\r\n.logo {\r\n  margin: 0 0 6px;\r\n  padding: 14px 16px;\r\n  border: 3px solid #ffffff99;\r\n  border-radius: 4px;\r\n  text-align: center;\r\n  font-weight: 800;\r\n  letter-spacing: .5px;\r\n}\r\n\r\n.projects-head {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  font-weight: 700;\r\n}\r\n.projects-head button {\r\n  background: none;\r\n  border: none;\r\n  color: #fff;\r\n  font-size: 20px;\r\n  cursor: pointer\r\n}\r\n.project-list { \r\n  list-style: none;\r\n  margin: 0;\r\n  padding: 0;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 10px \r\n}\r\n.project-item {\r\n  background: #fff;\r\n  color: #111;\r\n  padding: 10px 12px;\r\n  border-radius: 4px;\r\n  display: flex;\r\n  justify-content: space-between;\r\n  align-items: center;\r\n  box-shadow: var(--shadow)\r\n}\r\n.project-item.active { outline:3px solid #fff}\r\n.project-name { font-weight:700}\r\n\r\n.icon-btn { \r\n  background: none;\r\n  border: none;\r\n  color: #333;\r\n  font-size: 16px;\r\n  cursor: pointer \r\n}\r\n\r\n.board { padding:22px 28px 28px }\r\n.board-head { display:flex;align-items:center;gap:16px }\r\n.board-head h2{ margin:0;font-size:26px }\r\n.rule { height:3px;background:#ffffff99;flex:1;border-radius:2px }\r\n\r\n.pill {\r\n  margin: 12px 0 10px;\r\n  border: 2px solid #fff;border-radius:12px;background:var(--pill);\r\n  color: #fff;padding:8px 14px;cursor:pointer;font-weight:700;backdrop-filter:blur(2px)\r\n}\r\n\r\n#emptyHint { margin-top:8px;color:#f3f8fc }\r\n\r\n.task-list { list-style:none;margin:10px 0 0;padding:0;display:flex;flex-direction:column;gap:10px }\r\n.task {\r\n  background: #fdfdfd;color:#111;border-radius:6px;box-shadow:var(--shadow);\r\n  padding: 10px 12px;display:grid;grid-template-columns:auto 1fr auto auto;gap:8px;align-items:center\r\n}\r\n.task .title { font-weight:700 }\r\n.task .due { font-size:12px;color:#4a4a4a }\r\n.task .prio {\r\n  width:10px;height:10px;border-radius:50%;\r\n}\r\n.prio-low { background:#76b041 }\r\n.prio-med { background:#e6b800 }\r\n.prio-high { background:#d74a4a }\r\n\r\n.task .expander{ grid-column:1 / -1;margin-top:6px;color:#222;font-size:14px;display:none }\r\n.task.expanded .expander{ display:block }\r\n.controls{ display:flex;gap:8px }\r\n.controls .icon-btn{ color:#222;border:1px solid #ddd;border-radius:4px;padding:4px 6px;background:#fff }"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=bundle.f1db25c538cd8920c524.js.map